...
* **Нейронные сети для анализа настроения рынка по ценным бумагам** (ветка [LLM](https://github.com/wladradchenko/invest.wladradchenko.ru/tree/llm))
  * Модель LLM (версии с 2 ГБ видеопамяти или 12 ГБ) для анализа текста, изображений, видео и фильтрации комментариев
  * Анализатор настроений на основе текста
  * Анализатор эмоций на основе текста
  * Анализ комментариев за 7 дней по ценным бумагам
  * Расчет индикаторов настроений
...
0. Убедитесь, что у вас установлена CUDA версии 11.x или 12.x.
...
* macOS: `brew install ta-lib` (Неподдерживает версию с LLM)
...
| Технические индикаторы и прогнозируемая цена | Результаты портфеля |
|--------------|--------------|
